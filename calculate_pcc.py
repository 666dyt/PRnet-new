...
base_dir = '/media/mldadmin/home/s125mdg35_08/PRnet/results/lincs/'
# 1. 加载 4 个核心文件
y_true = pd.read_csv(base_dir + 'vega_500_2_epoch_y_true_array.csv', header=None).values
y_pre = pd.read_csv(base_dir + 'vega_500_2_epoch_y_pre_array.csv', header=None).values
x_true = pd.read_csv(base_dir + 'vega_500_2_epoch_x_true_array.csv', header=None).values

with open(base_dir + 'vega_500_2_epoch_cov_drug_array.csv', 'r', encoding='utf-8') as f:
...
plt.savefig('./results/lincs/vega_500_2_epoch_final.png')
